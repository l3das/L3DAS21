...
#dataset parameters
parser.add_argument('--training_predictors_path', type=str, default='DATASETS/processed/task1/training_predictors.pkl')
parser.add_argument('--training_target_path', type=str, default='DATASETS/processed/task1/training_target.pkl')
parser.add_argument('--validation_predictors_path', type=str, default='DATASETS/processed/task1/validation_predictors.pkl')
parser.add_argument('--validation_target_path', type=str, default='DATASETS/processed/task1/validation_target.pkl')
parser.add_argument('--test_predictors_path', type=str, default='DATASETS/processed/task1/test_predictors.pkl')
parser.add_argument('--test_target_path', type=str, default='DATASETS/processed/task1/test_target.pkl')
#training parameters
